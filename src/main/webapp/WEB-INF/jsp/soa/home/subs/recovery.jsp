...
<section id="widget-grid" class="">
	...
	<div class="row">
		...
		<article class="col-sm-12 col-md-12">
			...
			<div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
				<!-- widget options:
					...
					<div class="widget-body">
						...
						<div class="tabs-left">
							<ul class="nav nav-tabs tabs-left" id="demo-pill-nav">
								<li class="active">
									<a href="#tab-r1" data-toggle="tab"><span class="badge bg-color-blue txt-color-white">1</span> Diagram </a>
								</li>
								<li>
									<a href="#tab-r2" data-toggle="tab"><span class="badge bg-color-blueDark txt-color-white">2</span> Query Test </a>
								</li>
								<li>
									<a href="#tab-r3" data-toggle="tab"><span class="badge bg-color-greenLight txt-color-white">3</span> Query Statement </a>
								</li>
							</ul>
							<div class="tab-content">
								<div class="tab-pane active" id="tab-r1">
									<p>
										Database (ORCL1) <------ DBLink -------> Database (ORCL2)
									</p>
								</div>
		...
		<article class="col-sm-12 col-md-12">
			...
			<!-- Widget ID (each widget will need unique ID)-->
			<div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
				<!-- widget options:
				usage: <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false">
				...
				<div>
					...
					<div class="widget-body">
						...
						<div class="tabs-left">
							<ul class="nav nav-tabs tabs-left" id="demo-pill-nav">
								<li class="active">
									<a href="#tab-r4" data-toggle="tab"><span class="badge bg-color-blue txt-color-white">1</span> Diagram </a>
								</li>
								<li>
									<a href="#tab-r5" data-toggle="tab"><span class="badge bg-color-blueDark txt-color-white">2</span> Query Test </a>
								</li>
								<li>
									<a href="#tab-r6" data-toggle="tab"><span class="badge bg-color-greenLight txt-color-white">3</span> Query Statement </a>
								</li>
							</ul>
							<div class="tab-content">
								<div class="tab-pane active" id="tab-r4">
									<p>
										Database (ORCL1) <------ Oracle BPEL -------> Database (ORCL2)
									</p>
								</div>
...
<script type="text/javascript">
			...
			$('.table-striped').dataTable({
				...
				"preDrawCallback" : function() {
					...
					if (!responsiveHelper_dt_basic) {
						responsiveHelper_dt_basic = new ResponsiveDatatablesHelper($('.table-striped'), breakpointDefinition);
					}
				},
	...
	loadScript("<c:url value='/resources/bootstrap-template-smartAdmin/ajax-version/js/plugin/datatables/jquery.dataTables.min.js'/>", function(){
		loadScript("<c:url value='/resources/bootstrap-template-smartAdmin/ajax-version/js/plugin/datatables/dataTables.colVis.min.js'/>", function(){
			loadScript("<c:url value='/resources/bootstrap-template-smartAdmin/ajax-version/js/plugin/datatables/dataTables.tableTools.min.js'/>", function(){
				loadScript("<c:url value='/resources/bootstrap-template-smartAdmin/ajax-version/js/plugin/datatables/dataTables.bootstrap.min.js'/>", function(){
					loadScript("<c:url value='/resources/bootstrap-template-smartAdmin/ajax-version/js/plugin/datatable-responsive/datatables.responsive.min.js'/>", pagefunction)
				});
			});
		});
	});
