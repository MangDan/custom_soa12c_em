...
<title>LG Display BPMS에 오신것을 환영합니다.</title>
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('<c:url value='/resources/bpms/img/kospo/logo20.png' />')">
...
<table width="672" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="672" height="391" align="right" valign="bottom" background="<c:url value='/resources/bpms/img/lgdisplay/login_bg.png' />" style="padding:0 40 30 0"><table width="200" border="0" cellspacing="0" cellpadding="2">
        <tr> 
          ...
          <td width="70" rowspan="2" align="right" ><a href="javascript:submitForm();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','<c:url value='/resources/bpms/img/kospo/btn_loginon.gif' />',1)"><img src="<c:url value='/resources/bpms/img/kospo/btn_login.gif' />" name="Image2" width="65" height="47" border="0"></a></td>
        </tr>
        <tr> 
  ...
  <tr>
    <td align="center" valign="bottom" heigh="27">&nbsp;</td>
  </tr>
</table>
</form>
</body>
